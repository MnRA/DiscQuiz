...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k50035,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k50035,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__50041){
var vec__50042 = p__50041;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50042,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50042,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__50034){
var self__ = this;
var G__50034__$1 = this;
return (new cljs.core.RecordIter((0),G__50034__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this50036,other50037){
var self__ = this;
var this50036__$1 = this;
return (((!((other50037 == null)))) && ((this50036__$1.constructor === other50037.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50036__$1.tag,other50037.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50036__$1.prefix,other50037.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50036__$1.sym,other50037.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50036__$1.children,other50037.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50036__$1.__extmap,other50037.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__50034){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__50065 = cljs.core.keyword_identical_QMARK_;
var expr__50066 = k__4388__auto__;
if(cljs.core.truth_((pred__50065.cljs$core$IFn$_invoke$arity$2 ? pred__50065.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__50066) : pred__50065.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__50066)))){
return (new rewrite_clj.node.quote.QuoteNode(G__50034,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50065.cljs$core$IFn$_invoke$arity$2 ? pred__50065.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__50066) : pred__50065.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__50066)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__50034,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50065.cljs$core$IFn$_invoke$arity$2 ? pred__50065.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__50066) : pred__50065.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__50066)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__50034,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50065.cljs$core$IFn$_invoke$arity$2 ? pred__50065.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__50066) : pred__50065.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__50066)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__50034,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__50034),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__50034){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__50034,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__50038){
var extmap__4419__auto__ = (function (){var G__50114 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__50038,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__50038)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__50114);
} else {
return G__50114;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__50038),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__50038),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__50038),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__50038),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__50118 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__50118;
continue;
}
break;
...
var G__50119 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__50119;
continue;
}
break;
...
var G__50120 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__50120;
continue;
}
break;
...
var G__50121 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__50121;
continue;
}
break;
