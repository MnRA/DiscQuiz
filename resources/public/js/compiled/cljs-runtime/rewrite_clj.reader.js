...
var len__4736__auto___50823 = arguments.length;
var i__4737__auto___50824 = (0);
while(true){
if((i__4737__auto___50824 < len__4736__auto___50823)){
args__4742__auto__.push((arguments[i__4737__auto___50824]));

var G__50825 = (i__4737__auto___50824 + (1));
i__4737__auto___50824 = G__50825;
continue;
} else {
}
break;
...
/** @this {Function} */
(rewrite_clj.reader.throw_reader.cljs$lang$applyTo = (function (seq50800){
var G__50801 = cljs.core.first(seq50800);
var seq50800__$1 = cljs.core.next(seq50800);
var G__50802 = cljs.core.first(seq50800__$1);
var seq50800__$2 = cljs.core.next(seq50800__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50801,G__50802,seq50800__$2);
}));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(rewrite_clj.reader.read_until(reader,(function (p1__50813_SHARP_){
return (((p1__50813_SHARP_ == null)) || (rewrite_clj.reader.linebreak_QMARK_(p1__50813_SHARP_)));
...
var G__50843 = (cljs.core.truth_((p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(v) : p_QMARK_.call(null,v)))?(c + (1)):c);
var G__50844 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(vs,v);
c = G__50843;
vs = G__50844;
continue;
} else {
