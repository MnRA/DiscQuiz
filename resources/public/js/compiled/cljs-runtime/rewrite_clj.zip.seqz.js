...
var G__51168 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__51168__$1 = (((G__51168 == null))?null:cljs.core.iterate((function (loc){
...
var G__51168__$2 = (((G__51168__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__51168__$1));
var G__51168__$3 = (((G__51168__$2 == null))?null:cljs.core.last(G__51168__$2));
if((G__51168__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__51168__$3);
}
} else {
return zloc;
}
...
var G__51171 = rewrite_clj.zip.move.right(v);
var G__51172 = rewrite_clj.zip.move.up(v);
loc = G__51171;
parent = G__51172;
continue;
} else {
var G__51173 = rewrite_clj.zip.move.right(v0);
var G__51174 = parent;
loc = G__51173;
parent = G__51174;
continue;
...
var G__51175 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__51176 = rewrite_clj.zip.move.up(v);
loc = G__51175;
parent = G__51176;
continue;
} else {
var G__51177 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__51178 = parent;
loc = G__51177;
parent = G__51178;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__51169 = zloc;
var G__51169__$1 = (((G__51169 == null))?null:rewrite_clj.zip.move.down(G__51169));
var G__51169__$2 = (((G__51169__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__51169__$1,k));
if((G__51169__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__51169__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__51170 = rewrite_clj.zip.move.down(zloc);
var G__51170__$1 = (((G__51170 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__51170));
if((G__51170__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__51170__$1);
}
})(),k);
}
});
