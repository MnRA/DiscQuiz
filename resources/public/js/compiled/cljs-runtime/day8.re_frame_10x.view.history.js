...
var G__53999 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","load-epoch","epochs/load-epoch",166872985),id], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__53999) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.call(null,G__53999));
...
var all_events = cljs.core.deref((function (){var G__54000 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","all-events-by-id","epochs/all-events-by-id",-1225664812)], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__54000) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.call(null,G__54000));
})());
var current_id = cljs.core.deref((function (){var G__54001 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__54001) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.call(null,G__54001));
})());
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"history-list",new cljs.core.Keyword(null,"height","height",1025178622),"20%",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var iter__4529__auto__ = (function day8$re_frame_10x$view$history$render_$_iter__54002(s__54003){
return (new cljs.core.LazySeq(null,(function (){
var s__54003__$1 = s__54003;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__54003__$1);
if(temp__5735__auto__){
var s__54003__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54003__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__54003__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__54005 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__54004 = (0);
while(true){
if((i__54004 < size__4528__auto__)){
var vec__54006 = cljs.core._nth(c__4527__auto__,i__54004);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54006,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54006,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
cljs.core.chunk_append(b__54005,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__54014 = (i__54004 + (1));
i__54004 = G__54014;
continue;
} else {
var G__54015 = (i__54004 + (1));
i__54004 = G__54015;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54005),day8$re_frame_10x$view$history$render_$_iter__54002(cljs.core.chunk_rest(s__54003__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54005),null);
}
} else {
var vec__54010 = cljs.core.first(s__54003__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54010,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54010,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$history$render_$_iter__54002(cljs.core.rest(s__54003__$2)));
} else {
var G__54016 = cljs.core.rest(s__54003__$2);
s__54003__$1 = G__54016;
continue;
}
}
} else {
