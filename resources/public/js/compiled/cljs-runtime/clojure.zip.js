...
var G__50968 = clojure.zip.node(loc);
var fexpr__50967 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__50967.cljs$core$IFn$_invoke$arity$1 ? fexpr__50967.cljs$core$IFn$_invoke$arity$1(G__50968) : fexpr__50967.call(null,G__50968));
});
/**
...
var G__50970 = clojure.zip.node(loc);
var fexpr__50969 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__50969.cljs$core$IFn$_invoke$arity$1 ? fexpr__50969.cljs$core$IFn$_invoke$arity$1(G__50970) : fexpr__50969.call(null,G__50970));
} else {
...
var fexpr__50971 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__50971.cljs$core$IFn$_invoke$arity$2 ? fexpr__50971.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__50971.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__50972 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50972,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50972,(1),null);
var vec__50975 = clojure.zip.children(loc);
var seq__50976 = cljs.core.seq(vec__50975);
var first__50977 = cljs.core.first(seq__50976);
var seq__50976__$1 = cljs.core.next(seq__50976);
var c = first__50977;
var cnext = seq__50976__$1;
var cs = vec__50975;
...
var vec__50978 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50978,(0),null);
var map__50981 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50978,(1),null);
...
var path = map__50981__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50981__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50981__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50981__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50981__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50981__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__50983 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50983,(0),null);
...
var path = map__50986__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50986__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__50987 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50986__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__50991 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50991,(0),null);
var map__50994 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50991,(1),null);
...
var path = map__50994__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50994__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50994__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return r;
} else {
...
var vec__50996 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50996,(0),null);
var map__50999 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50996,(1),null);
...
var path = map__50999__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50999__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50999__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
...
var vec__51001 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51001,(0),null);
var map__51004 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51001,(1),null);
...
var path = map__51004__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51004__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51004__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__51006 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51006,(0),null);
...
var path = map__51009__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51009__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__51011 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51011,(0),null);
var map__51014 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51011,(1),null);
...
var path = map__51014__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51014__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var i__4737__auto___51048 = (0);
while(true){
if((i__4737__auto___51048 < len__4736__auto___51047)){
args__4742__auto__.push((arguments[i__4737__auto___51048]));

var G__51049 = (i__4737__auto___51048 + (1));
i__4737__auto___51048 = G__51049;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq51019){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51020,G__51021,seq51019__$2);
}));
...
var G__51051 = clojure.zip.rightmost(child);
loc__$1 = G__51051;
continue;
} else {
return loc__$1;
...
var vec__51022 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51022,(0),null);
var map__51025 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51022,(1),null);
...
var path = map__51025__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51025__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51025__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51025__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51025__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__51052 = clojure.zip.rightmost(child);
loc__$1 = G__51052;
continue;
} else {
return loc__$1;
