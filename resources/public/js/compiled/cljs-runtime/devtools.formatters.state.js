...
var len__4736__auto___44110 = arguments.length;
var i__4737__auto___44111 = (0);
while(true){
if((i__4737__auto___44111 < len__4736__auto___44110)){
args__4742__auto__.push((arguments[i__4737__auto___44111]));

var G__44112 = (i__4737__auto___44111 + (1));
i__4737__auto___44111 = G__44112;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq44098){
var G__44099 = cljs.core.first(seq44098);
var seq44098__$1 = cljs.core.next(seq44098);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44099,seq44098__$1);
}));
...
return cljs.core.some((function (p1__44105_SHARP_){
return (p1__44105_SHARP_ === object);
}),history);
});
