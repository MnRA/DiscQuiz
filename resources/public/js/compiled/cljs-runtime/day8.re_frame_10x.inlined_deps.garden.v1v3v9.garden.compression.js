 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__46478){
var vec__46482 = p__46478;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46482,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46482,(1),null);
return (function (s){
...
var len__4736__auto___46503 = arguments.length;
var i__4737__auto___46504 = (0);
while(true){
if((i__4737__auto___46504 < len__4736__auto___46503)){
args__4742__auto__.push((arguments[i__4737__auto___46504]));

var G__46505 = (i__4737__auto___46504 + (1));
i__4737__auto___46504 = G__46505;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__46488_SHARP_){
return (p1__46488_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__46488_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__46488_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq46489){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq46489));
}));
...
var map__46492 = temp__5733__auto__;
...
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46492__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46492__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46492__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__46512 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__46513 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__46499 = tag;
var G__46499__$1 = (((G__46499 instanceof cljs.core.Keyword))?G__46499.fqn:null);
switch (G__46499__$1) {
case "string":
return chunk;
