...
var vec__50979 = cljs.core.rest(expr);
...
var vec__50982 = first__50981;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50982,(0),null);
var form = seq__50980__$1;
...
var G__50991 = x;
var G__50991__$1 = (((G__50991 == null))?null:spec_tools.impl.polish(G__50991));
var G__50991__$2 = (((G__50991__$1 == null))?null:cljs.core.name(G__50991__$1));
if((G__50991__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__50991__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__50993 = x;
var G__50993__$1 = (((G__50993 == null))?null:cljs.core.name(G__50993));
if((G__50993__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__50993__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__50994){
...
var data = map__50995__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50995__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50995__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50995__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50995__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__51001){
...
var data = map__51002__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51002__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51002__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__51004 = data;
var G__51004__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__51004,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__51004);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__51004__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__51004__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__51018 = form;
var G__51018__$1 = (((G__51018 == null))?null:cljs.core.rest(G__51018));
if((G__51018__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__51018__$1);
}
})();
var G__51019 = m;
var G__51019__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__51019,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__51011_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__51011_SHARP_)));
})):G__51019);
var G__51019__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__51019__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__51012_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__51012_SHARP_)));
})):G__51019__$1);
var G__51019__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__51019__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__51013_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__51013_SHARP_));
})):G__51019__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__51019__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__51026 = (function (){var G__51027 = form;
var G__51027__$1 = (((G__51027 == null))?null:cljs.core.rest(G__51027));
if((G__51027__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__51027__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51026__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51026__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51026__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51026__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__51041 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__51041) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__51044 = form;
var G__51044__$1 = (((G__51044 == null))?null:cljs.core.seq(G__51044));
var G__51044__$2 = (((G__51044__$1 == null))?null:cljs.core.first(G__51044__$1));
if((G__51044__$2 == null)){
return null;
} else {
var fexpr__51045 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__51045.cljs$core$IFn$_invoke$arity$1 ? fexpr__51045.cljs$core$IFn$_invoke$arity$1(G__51044__$2) : fexpr__51045.call(null,G__51044__$2));
}
})():null));
});
/**
...
var len__4736__auto___51115 = arguments.length;
var i__4737__auto___51116 = (0);
while(true){
if((i__4737__auto___51116 < len__4736__auto___51115)){
args__4742__auto__.push((arguments[i__4737__auto___51116]));

var G__51120 = (i__4737__auto___51116 + (1));
i__4737__auto___51116 = G__51120;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq51047){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq51047));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__51051){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__51062){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51063__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51063__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51063__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51063__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__51060_SHARP_){
return cljs.core.map_QMARK_(p1__51060_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__51061_SHARP_){
return cljs.core.contains_QMARK_(p1__51061_SHARP_,x);
});
}),req_keys));
