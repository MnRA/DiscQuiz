...
var G__51375 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__51375;
continue;
} else {
var G__51376 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__51376;
continue;
}
} else {
var G__51377 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__51377;
continue;
}
}
...
var G__51369 = zloc;
var G__51370 = (function (){var G__51371 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__51372 = zloc;
var G__51372__$1 = (((G__51372 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__51372) : rewrite_clj.zip.node.call(null,G__51372)));
if((G__51372__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__51372__$1) : zprint.zutil.edn_STAR_.call(null,G__51372__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__51371) : rewrite_clj.zip.root.call(null,G__51371));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__51369,G__51370) : rewrite_clj.zip.replace.call(null,G__51369,G__51370));
});
/**
...
var G__51378 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__51378;
continue;
}
break;
...
var G__51379 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__51380 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__51379;
out = G__51380;
continue;
} else {
...
var G__51381 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__51382 = cljs.core.next(new_loc);
var G__51383 = replaced_loc;
nloc = G__51381;
new_loc = G__51382;
last_loc = G__51383;
continue;
...
return zprint.rewrite.sort_val((function (){var G__51373 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__51373) : rewrite_clj.zip.down.call(null,G__51373));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__51374_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__51374_SHARP_) : rewrite_clj.zip.tag.call(null,p1__51374_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__51374_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__51374_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
