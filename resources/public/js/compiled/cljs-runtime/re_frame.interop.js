...
return [(function (){var pred__53251 = cljs.core.instance_QMARK_;
var expr__53252 = reactive_val;
if(cljs.core.truth_((pred__53251.cljs$core$IFn$_invoke$arity$2 ? pred__53251.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__53252) : pred__53251.call(null,reagent.ratom.RAtom,expr__53252)))){
return "ra";
} else {
if(cljs.core.truth_((pred__53251.cljs$core$IFn$_invoke$arity$2 ? pred__53251.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__53252) : pred__53251.call(null,reagent.ratom.RCursor,expr__53252)))){
return "rc";
} else {
if(cljs.core.truth_((pred__53251.cljs$core$IFn$_invoke$arity$2 ? pred__53251.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__53252) : pred__53251.call(null,reagent.ratom.Reaction,expr__53252)))){
return "rx";
} else {
if(cljs.core.truth_((pred__53251.cljs$core$IFn$_invoke$arity$2 ? pred__53251.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__53252) : pred__53251.call(null,reagent.ratom.Track,expr__53252)))){
return "tr";
} else {
return "other";
}
