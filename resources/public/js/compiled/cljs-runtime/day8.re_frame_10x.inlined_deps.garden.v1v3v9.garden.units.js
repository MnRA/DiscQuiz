 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$convert(p__46495,right){
...
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46496__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46496__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__46506 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46506,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46506,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46506,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46509__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46510 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46510__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__46667__delegate = function (x,y,more){
...
var G__46667 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__46668__i = 0, G__46668__a = new Array(arguments.length -  2);
while (G__46668__i < G__46668__a.length) {G__46668__a[G__46668__i] = arguments[G__46668__i + 2]; ++G__46668__i;}
  more = new cljs.core.IndexedSeq(G__46668__a,0,null);
} 
return G__46667__delegate.call(this,x,y,more);};
G__46667.cljs$lang$maxFixedArity = 2;
G__46667.cljs$lang$applyTo = (function (arglist__46673){
var x = cljs.core.first(arglist__46673);
arglist__46673 = cljs.core.next(arglist__46673);
var y = cljs.core.first(arglist__46673);
var more = cljs.core.rest(arglist__46673);
return G__46667__delegate(x,y,more);
});
...
var G__46674 = null;
if (arguments.length > 2) {
var G__46675__i = 0, G__46675__a = new Array(arguments.length -  2);
while (G__46675__i < G__46675__a.length) {G__46675__a[G__46675__i] = arguments[G__46675__i + 2]; ++G__46675__i;}
G__46674 = new cljs.core.IndexedSeq(G__46675__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46674);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46518__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46519 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46519__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
...
while (G__46678__i < G__46678__a.length) {G__46678__a[G__46678__i] = arguments[G__46678__i + 2]; ++G__46678__i;}
  more = new cljs.core.IndexedSeq(G__46678__a,0,null);
} 
...
var G__46681 = null;
if (arguments.length > 2) {
var G__46682__i = 0, G__46682__a = new Array(arguments.length -  2);
while (G__46682__i < G__46682__a.length) {G__46682__a[G__46682__i] = arguments[G__46682__i + 2]; ++G__46682__i;}
G__46681 = new cljs.core.IndexedSeq(G__46682__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46681);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46555__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46556 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46556__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__46686__delegate = function (x,y,more){
...
var G__46686 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__46687__i = 0, G__46687__a = new Array(arguments.length -  2);
while (G__46687__i < G__46687__a.length) {G__46687__a[G__46687__i] = arguments[G__46687__i + 2]; ++G__46687__i;}
  more = new cljs.core.IndexedSeq(G__46687__a,0,null);
} 
return G__46686__delegate.call(this,x,y,more);};
G__46686.cljs$lang$maxFixedArity = 2;
G__46686.cljs$lang$applyTo = (function (arglist__46688){
var x = cljs.core.first(arglist__46688);
arglist__46688 = cljs.core.next(arglist__46688);
var y = cljs.core.first(arglist__46688);
var more = cljs.core.rest(arglist__46688);
return G__46686__delegate(x,y,more);
});
...
var G__46689 = null;
if (arguments.length > 2) {
var G__46690__i = 0, G__46690__a = new Array(arguments.length -  2);
while (G__46690__i < G__46690__a.length) {G__46690__a[G__46690__i] = arguments[G__46690__i + 2]; ++G__46690__i;}
G__46689 = new cljs.core.IndexedSeq(G__46690__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46689);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46562__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46563 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46563__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__46693__delegate = function (x,y,more){
...
var G__46693 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
...
while (G__46695__i < G__46695__a.length) {G__46695__a[G__46695__i] = arguments[G__46695__i + 2]; ++G__46695__i;}
  more = new cljs.core.IndexedSeq(G__46695__a,0,null);
} 
return G__46693__delegate.call(this,x,y,more);};
G__46693.cljs$lang$maxFixedArity = 2;
G__46693.cljs$lang$applyTo = (function (arglist__46696){
var x = cljs.core.first(arglist__46696);
arglist__46696 = cljs.core.next(arglist__46696);
var y = cljs.core.first(arglist__46696);
var more = cljs.core.rest(arglist__46696);
return G__46693__delegate(x,y,more);
});
...
var G__46697 = null;
if (arguments.length > 2) {
var G__46698__i = 0, G__46698__a = new Array(arguments.length -  2);
while (G__46698__i < G__46698__a.length) {G__46698__a[G__46698__i] = arguments[G__46698__i + 2]; ++G__46698__i;}
G__46697 = new cljs.core.IndexedSeq(G__46698__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46697);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
