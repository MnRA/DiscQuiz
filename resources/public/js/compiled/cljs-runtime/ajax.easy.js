...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__49363 = cljs.core.second(format);
var G__49364 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__49363,G__49364) : ajax.easy.keyword_response_format_element.call(null,G__49363,G__49364));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__49365 = format;
var G__49365__$1 = (((G__49365 instanceof cljs.core.Keyword))?G__49365.fqn:null);
switch (G__49365__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49366_SHARP_){
return ajax.easy.keyword_response_format_element(p1__49366_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__49368){
var map__49369 = p__49368;
var map__49369__$1 = (((((!((map__49369 == null))))?(((((map__49369.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49369.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49369):map__49369);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49369__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49369__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49369__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__49371){
var vec__49372 = p__49371;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49372,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49372,(1),null);
var fexpr__49375_49396 = (cljs.core.truth_(ok)?h:e);
(fexpr__49375_49396.cljs$core$IFn$_invoke$arity$1 ? fexpr__49375_49396.cljs$core$IFn$_invoke$arity$1(result) : fexpr__49375_49396.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__49376){
...
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49377__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49377__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49377__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49377__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49377__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
