...
if((x instanceof cljs.core.Keyword)){
var G__52085 = spec;
var G__52086 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__52085,G__52086) : f.call(null,G__52085,G__52086));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__52094 = spec;
var G__52095 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__52094,G__52095) : f.call(null,G__52094,G__52095));
} else {
return x;
...
if(typeof x === 'number'){
var G__52097 = spec;
var G__52098 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__52097,G__52098) : f.call(null,G__52097,G__52098));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e52099){if((e52099 instanceof Error)){
var ___$1 = e52099;
return x;
} else {
throw e52099;
...
}catch (e52101){if((e52101 instanceof Error)){
var ___$1 = e52101;
return x;
} else {
throw e52101;
...
}catch (e52103){if((e52103 instanceof Error)){
var ___$1 = e52103;
return x;
} else {
throw e52103;
...
}catch (e52104){if((e52104 instanceof Error)){
var ___$1 = e52104;
return x;
} else {
throw e52104;
...
}catch (e52105){if((e52105 instanceof Error)){
var ___$1 = e52105;
return x;
} else {
throw e52105;
...
}catch (e52106){if((e52106 instanceof Error)){
var ___$1 = e52106;
return x;
} else {
throw e52106;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__52107,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52108__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__52110,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52111__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__52114,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52115__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
