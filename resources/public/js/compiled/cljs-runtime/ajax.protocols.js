...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_49076 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_49076(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_49089 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_49089(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_49100 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_49100(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_49117 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_49117(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_49123 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_49123(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_49128 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_49128(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_49132 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_49132(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_49135 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_49135(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_49140 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_49140(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_49141 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_49141(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k49063,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49063,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__49068){
var vec__49069 = p__49068;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49069,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49069,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49062){
var self__ = this;
var G__49062__$1 = this;
return (new cljs.core.RecordIter((0),G__49062__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this49064,other49065){
var self__ = this;
var this49064__$1 = this;
return (((!((other49065 == null)))) && ((this49064__$1.constructor === other49065.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49064__$1.status,other49065.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49064__$1.body,other49065.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49064__$1.status_text,other49065.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49064__$1.headers,other49065.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49064__$1.was_aborted,other49065.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49064__$1.__extmap,other49065.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__49062){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__49072 = cljs.core.keyword_identical_QMARK_;
var expr__49073 = k__4388__auto__;
if(cljs.core.truth_((pred__49072.cljs$core$IFn$_invoke$arity$2 ? pred__49072.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__49073) : pred__49072.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__49073)))){
return (new ajax.protocols.Response(G__49062,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__49072.cljs$core$IFn$_invoke$arity$2 ? pred__49072.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__49073) : pred__49072.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__49073)))){
return (new ajax.protocols.Response(self__.status,G__49062,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__49072.cljs$core$IFn$_invoke$arity$2 ? pred__49072.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__49073) : pred__49072.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__49073)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__49062,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__49072.cljs$core$IFn$_invoke$arity$2 ? pred__49072.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__49073) : pred__49072.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__49073)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__49062,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__49072.cljs$core$IFn$_invoke$arity$2 ? pred__49072.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__49073) : pred__49072.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__49073)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__49062,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__49062),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__49062){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__49062,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__49066){
var extmap__4419__auto__ = (function (){var G__49075 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__49066,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__49066)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49075);
} else {
return G__49075;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__49066),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__49066),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__49066),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__49066),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__49066),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
