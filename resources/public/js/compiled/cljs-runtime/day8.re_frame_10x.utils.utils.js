...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__47860_SHARP_,p2__47859_SHARP_){
if(cljs.core.truth_((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p2__47859_SHARP_) : pred.call(null,p2__47859_SHARP_)))){
return p1__47860_SHARP_;
} else {
return null;
}
}),v);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__47864_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__47864_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__47864_SHARP_) <= ending)));
}));
});
...
var len__4736__auto___47913 = arguments.length;
var i__4737__auto___47914 = (0);
while(true){
if((i__4737__auto___47914 < len__4736__auto___47913)){
args__4742__auto__.push((arguments[i__4737__auto___47914]));

var G__47915 = (i__4737__auto___47914 + (1));
i__4737__auto___47914 = G__47915;
continue;
} else {
}
break;
...
(day8.re_frame_10x.utils.utils.pluralize.cljs$core$IFn$_invoke$arity$variadic = (function (num,singular,p__47879){
var vec__47880 = p__47879;
var plural = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47880,(0),null);
...
/** @this {Function} */
(day8.re_frame_10x.utils.utils.pluralize.cljs$lang$applyTo = (function (seq47876){
var G__47877 = cljs.core.first(seq47876);
var seq47876__$1 = cljs.core.next(seq47876);
var G__47878 = cljs.core.first(seq47876__$1);
var seq47876__$2 = cljs.core.next(seq47876__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47877,G__47878,seq47876__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___47919 = arguments.length;
var i__4737__auto___47920 = (0);
while(true){
if((i__4737__auto___47920 < len__4736__auto___47919)){
args__4742__auto__.push((arguments[i__4737__auto___47920]));

var G__47921 = (i__4737__auto___47920 + (1));
i__4737__auto___47920 = G__47921;
continue;
} else {
}
break;
...
(day8.re_frame_10x.utils.utils.pluralize_.cljs$core$IFn$_invoke$arity$variadic = (function (num,singular,p__47888){
var vec__47889 = p__47888;
var plural = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47889,(0),null);
...
/** @this {Function} */
(day8.re_frame_10x.utils.utils.pluralize_.cljs$lang$applyTo = (function (seq47885){
var G__47886 = cljs.core.first(seq47885);
var seq47885__$1 = cljs.core.next(seq47885);
var G__47887 = cljs.core.first(seq47885__$1);
var seq47885__$2 = cljs.core.next(seq47885__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47886,G__47887,seq47885__$2);
}));
