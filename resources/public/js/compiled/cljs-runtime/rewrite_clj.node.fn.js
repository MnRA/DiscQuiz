...
var syms = (function (){var iter__4529__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__50443(s__50444){
...
var c__4527__auto__ = cljs.core.chunk_first(s__50444__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__50446 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__50445 = (0);
while(true){
if((i__50445 < size__4528__auto__)){
var i = cljs.core._nth(c__4527__auto__,i__50445);
...
cljs.core.chunk_append(b__50446,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__50497 = (i__50445 + (1));
i__50445 = G__50497;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50446),rewrite_clj$node$fn$fn_walk_$_iter__50443(cljs.core.chunk_rest(s__50444__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50446),null);
}
} else {
var i = cljs.core.first(s__50444__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__50443(cljs.core.rest(s__50444__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__50442_SHARP_){
var or__4126__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__50442_SHARP_);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return p1__50442_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k50458,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__50462 = k50458;
var G__50462__$1 = (((G__50462 instanceof cljs.core.Keyword))?G__50462.fqn:null);
switch (G__50462__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k50458,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__50463){
var vec__50464 = p__50463;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50464,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50464,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__50457){
var self__ = this;
var G__50457__$1 = this;
return (new cljs.core.RecordIter((0),G__50457__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this50459,other50460){
var self__ = this;
var this50459__$1 = this;
return (((!((other50460 == null)))) && ((this50459__$1.constructor === other50460.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50459__$1.children,other50460.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50459__$1.__extmap,other50460.__extmap)));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__50457){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__50484 = cljs.core.keyword_identical_QMARK_;
var expr__50485 = k__4388__auto__;
if(cljs.core.truth_((pred__50484.cljs$core$IFn$_invoke$arity$2 ? pred__50484.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__50485) : pred__50484.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__50485)))){
return (new rewrite_clj.node.fn.FnNode(G__50457,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__50457),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__50457){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__50457,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__50461){
var extmap__4419__auto__ = (function (){var G__50490 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__50461,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__50461)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__50490);
} else {
return G__50490;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__50461),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
