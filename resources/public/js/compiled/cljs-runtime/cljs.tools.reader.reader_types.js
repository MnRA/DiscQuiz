...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45578 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45578(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45579 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45579(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45580 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45580(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45581 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45581(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45582 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45582(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45583 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45583(reader);
}
});
...
var G__45608 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45609 = s.append(c);
c = G__45608;
s = G__45609;
continue;
}
