...
var vec__52540 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__52543 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52543,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52543,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52540,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52540,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__52546){
var vec__52547 = p__52546;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52547,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52547,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52550,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52550,(1),null);
...
var vec__52554 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52554,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52554,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52554,(2),null);
var vec__52557 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52557,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52557,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52557,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__52569){
var vec__52570 = p__52569;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52570,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52570,(1),null);
...
var len__4736__auto___52661 = arguments.length;
var i__4737__auto___52662 = (0);
while(true){
if((i__4737__auto___52662 < len__4736__auto___52661)){
args__4742__auto__.push((arguments[i__4737__auto___52662]));

var G__52663 = (i__4737__auto___52662 + (1));
i__4737__auto___52662 = G__52663;
continue;
} else {
}
break;
...
var vec__52579 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52579,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52579,(1),null);
...
var G__52582 = zprint.core.parse_string_all_options(rest_options);
var G__52583 = zprint.core.zprint_str_internal;
var G__52584 = ":parse-string-all? call";
var G__52585 = (function (){var G__52586 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__52586) : zprint.zutil.edn_STAR_.call(null,G__52586));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__52582,G__52583,G__52584,G__52585) : zprint.core.process_multiple_forms.call(null,G__52582,G__52583,G__52584,G__52585));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__52587 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52587,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52587,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq52573){
...
var args__4742__auto__ = [];
var len__4736__auto___52673 = arguments.length;
var i__4737__auto___52674 = (0);
while(true){
if((i__4737__auto___52674 < len__4736__auto___52673)){
args__4742__auto__.push((arguments[i__4737__auto___52674]));

var G__52675 = (i__4737__auto___52674 + (1));
i__4737__auto___52674 = G__52675;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq52592){
var G__52593 = cljs.core.first(seq52592);
var seq52592__$1 = cljs.core.next(seq52592);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52593,seq52592__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___52676 = arguments.length;
var i__4737__auto___52677 = (0);
while(true){
if((i__4737__auto___52677 < len__4736__auto___52676)){
args__4742__auto__.push((arguments[i__4737__auto___52677]));

var G__52678 = (i__4737__auto___52677 + (1));
i__4737__auto___52677 = G__52678;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq52594){
var G__52595 = cljs.core.first(seq52594);
var seq52594__$1 = cljs.core.next(seq52594);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52595,seq52594__$1);
}));
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq52596){
...
var args__4742__auto__ = [];
var len__4736__auto___52682 = arguments.length;
var i__4737__auto___52683 = (0);
while(true){
if((i__4737__auto___52683 < len__4736__auto___52682)){
args__4742__auto__.push((arguments[i__4737__auto___52683]));

var G__52684 = (i__4737__auto___52683 + (1));
i__4737__auto___52683 = G__52684;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq52603){
var G__52604 = cljs.core.first(seq52603);
var seq52603__$1 = cljs.core.next(seq52603);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52604,seq52603__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__52607,form){
var vec__52608 = p__52607;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52608,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52608,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52608,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52608,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__52611 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52611,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52611,(1),null);
...
var forms = (function (){var G__52616 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__52616) : zprint.zutil.edn_STAR_.call(null,G__52616));
})();
