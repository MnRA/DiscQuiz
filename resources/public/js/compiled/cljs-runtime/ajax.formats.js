...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__49322){
...
var request = map__49323__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49323__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__49327 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__49327.cljs$core$IFn$_invoke$arity$1 ? fexpr__49327.cljs$core$IFn$_invoke$arity$1(response) : fexpr__49327.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__49328 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__49328.cljs$core$IFn$_invoke$arity$1 ? fexpr__49328.cljs$core$IFn$_invoke$arity$1(response) : fexpr__49328.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__49329){
...
var request = map__49330__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49330__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
