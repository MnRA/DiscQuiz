...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k50569,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k50569,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__50580){
var vec__50581 = p__50580;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50581,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50581,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__50568){
var self__ = this;
var G__50568__$1 = this;
return (new cljs.core.RecordIter((0),G__50568__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this50570,other50571){
var self__ = this;
var this50570__$1 = this;
return (((!((other50571 == null)))) && ((this50570__$1.constructor === other50571.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50570__$1.tag,other50571.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50570__$1.wrap_fn,other50571.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50570__$1.wrap_length,other50571.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50570__$1.seq_fn,other50571.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50570__$1.children,other50571.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50570__$1.__extmap,other50571.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__50593 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__50593) : self__.seq_fn.call(null,G__50593));
}));
...
var self__ = this;
var this$__$1 = this;
var G__50594 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__50594) : self__.wrap_fn.call(null,G__50594));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__50568){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__50595 = cljs.core.keyword_identical_QMARK_;
var expr__50596 = k__4388__auto__;
if(cljs.core.truth_((pred__50595.cljs$core$IFn$_invoke$arity$2 ? pred__50595.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__50596) : pred__50595.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__50596)))){
return (new rewrite_clj.node.seq.SeqNode(G__50568,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50595.cljs$core$IFn$_invoke$arity$2 ? pred__50595.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__50596) : pred__50595.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__50596)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__50568,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50595.cljs$core$IFn$_invoke$arity$2 ? pred__50595.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__50596) : pred__50595.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__50596)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__50568,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50595.cljs$core$IFn$_invoke$arity$2 ? pred__50595.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__50596) : pred__50595.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__50596)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__50568,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50595.cljs$core$IFn$_invoke$arity$2 ? pred__50595.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__50596) : pred__50595.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__50596)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__50568,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__50568),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__50568){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__50568,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__50572){
var extmap__4419__auto__ = (function (){var G__50607 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__50572,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__50572)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__50607);
} else {
return G__50607;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__50572),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__50572),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__50572),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__50572),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__50572),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__50608_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__50608_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__50615_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__50615_SHARP_);
}),children);
});
