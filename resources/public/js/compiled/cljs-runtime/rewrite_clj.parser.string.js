...
if((c === "\n")){
var G__50853 = escape_QMARK_;
var G__50854 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__50853;
lines = G__50854;
continue;
} else {
buf.append(c);

var G__50855 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__50856 = lines;
escape_QMARK_ = G__50855;
lines = G__50856;
continue;
...
var G__50850 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__50850) : rewrite_clj.node.string_node.call(null,G__50850));
});
...
var G__50851 = cljs.core.re_pattern(regex);
var G__50852 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__50851,G__50852) : rewrite_clj.node.token_node.call(null,G__50851,G__50852));
});
