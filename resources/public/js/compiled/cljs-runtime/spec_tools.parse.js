...
var fexpr__51963 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__51963.cljs$core$IFn$_invoke$arity$1 ? fexpr__51963.cljs$core$IFn$_invoke$arity$1(type) : fexpr__51963.call(null,type));
});
...
var G__52078 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__52078;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__51968 = spec_tools.impl.normalize_symbol(x);
var G__51969 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__51968,G__51969) : spec_tools.parse.parse_form.call(null,G__51968,G__51969));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__51970 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__51971 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__51970,G__51971) : spec_tools.parse.parse_form.call(null,G__51970,G__51971));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__52080 = cljs.spec.alpha.form(x);
x = G__52080;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__51972 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__51973 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__51972,G__51973) : spec_tools.parse.parse_form.call(null,G__51972,G__51973));
} else {
...
var G__51976 = parse_data;
var G__51976__$1 = (((G__51976 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__51976));
var G__51976__$2 = (((G__51976__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__51976__$1));
var G__51976__$3 = (((G__51976__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__51976__$2));
var G__51976__$4 = (((G__51976__$3 == null))?null:cljs.core.seq(G__51976__$3));
if((G__51976__$4 == null)){
return null;
} else {
return cljs.core.set(G__51976__$4);
}
}
});
...
var map__52013 = spec_tools.impl.parse_keys(form);
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52013__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52013__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52013__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52013__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52013__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__52016 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__52016__$1 = (cljs.core.truth_((function (){var or__4126__auto__ = req;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52016,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__52016);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52016__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__52016__$1;
}
}));
...
var vec__52018 = multi_spec_form;
var seq__52019 = cljs.core.seq(vec__52018);
var first__52020 = cljs.core.first(seq__52019);
var seq__52019__$1 = cljs.core.next(seq__52019);
var _ = first__52020;
var first__52020__$1 = cljs.core.first(seq__52019__$1);
var seq__52019__$2 = cljs.core.next(seq__52019__$1);
var multi_method_symbol = first__52020__$1;
var ___$1 = seq__52019__$2;
var form = vec__52018;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52025){
var vec__52026 = p__52025;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52026,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52026,(1),null);
...
var type_priority = (function (p1__52041_SHARP_){
var G__52043 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(0),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(1)], null);
var G__52044 = (0);
var fexpr__52042 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__52041_SHARP_);
return (fexpr__52042.cljs$core$IFn$_invoke$arity$2 ? fexpr__52042.cljs$core$IFn$_invoke$arity$2(G__52043,G__52044) : fexpr__52042.call(null,G__52043,G__52044));
});
...
var map__52045 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52045__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__52058 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52058__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__52060){
var vec__52061 = p__52060;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52061,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52061,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52061,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__52067){
...
var ___$1 = first__52070;
var values = seq__52069__$1;
...
var type_priority = (function (p1__52071_SHARP_){
var G__52073 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__52072 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__52071_SHARP_);
return (fexpr__52072.cljs$core$IFn$_invoke$arity$1 ? fexpr__52072.cljs$core$IFn$_invoke$arity$1(G__52073) : fexpr__52072.call(null,G__52073));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.parse_spec,cljs.core.rest(form))));
}));
