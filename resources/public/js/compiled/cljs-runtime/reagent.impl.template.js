...
var G__53042 = o;
goog.object.set(G__53042,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__53133__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__53133 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__53134__i = 0, G__53134__a = new Array(arguments.length -  0);
while (G__53134__i < G__53134__a.length) {G__53134__a[G__53134__i] = arguments[G__53134__i + 0]; ++G__53134__i;}
  args = new cljs.core.IndexedSeq(G__53134__a,0,null);
} 
return G__53133__delegate.call(this,args);};
G__53133.cljs$lang$maxFixedArity = 0;
G__53133.cljs$lang$applyTo = (function (arglist__53135){
var args = cljs.core.seq(arglist__53135);
return G__53133__delegate(args);
});
G__53133.cljs$core$IFn$_invoke$arity$variadic = G__53133__delegate;
return G__53133;
})()
;
} else {
...
var G__53047 = o;
goog.object.set(G__53047,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__53136__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__53136 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__53137__i = 0, G__53137__a = new Array(arguments.length -  0);
while (G__53137__i < G__53137__a.length) {G__53137__a[G__53137__i] = arguments[G__53137__i + 0]; ++G__53137__i;}
  args = new cljs.core.IndexedSeq(G__53137__a,0,null);
} 
return G__53136__delegate.call(this,args);};
G__53136.cljs$lang$maxFixedArity = 0;
G__53136.cljs$lang$applyTo = (function (arglist__53138){
var args = cljs.core.seq(arglist__53138);
return G__53136__delegate(args);
});
G__53136.cljs$core$IFn$_invoke$arity$variadic = G__53136__delegate;
return G__53136;
})()
;
} else {
...
var G__53048 = props;
var G__53048__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53048,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__53048);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53048__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__53048__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__53070 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53070,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__53070;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__53083){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53084__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__53086_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__53086_SHARP_);
}));
} else {
return null;
}
...
var vec__53093 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53093,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53093,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53093,(2),null);
...
var temp__5739__auto___53140 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___53140 == null)){
} else {
var key_53141 = temp__5739__auto___53140;
(jsprops.key = key_53141);
}
...
var temp__5739__auto___53142 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___53142 == null)){
} else {
var key_53143 = temp__5739__auto___53142;
(jsprops.key = key_53143);
}
...
var G__53113 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__53113) : reagent.impl.template.as_element.call(null,G__53113));
} else {
var temp__5739__auto___53154 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___53154 == null)){
} else {
var key_53155 = temp__5739__auto___53154;
(jsprops.key = key_53155);
}
...
var G__53117 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__53117)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__53117)){
return x;
} else {
...
args__4742__auto__.push((arguments[i__4737__auto___53157]));
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq53122){
var G__53123 = cljs.core.first(seq53122);
var seq53122__$1 = cljs.core.next(seq53122);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53123,seq53122__$1);
}));
...
break;
default:
var G__53160 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__53160;
continue;
...
var ctx = ({});
var vec__53129 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53129,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53129,(1),null);
...
var G__53132 = (cljs.core.count(argv) - first_child);
switch (G__53132) {
case (0):
