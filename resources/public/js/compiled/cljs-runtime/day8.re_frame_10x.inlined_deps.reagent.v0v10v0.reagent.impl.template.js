...
var G__48090__i = 0, G__48090__a = new Array(arguments.length -  0);
while (G__48090__i < G__48090__a.length) {G__48090__a[G__48090__i] = arguments[G__48090__i + 0]; ++G__48090__i;}
  args = new cljs.core.IndexedSeq(G__48090__a,0,null);
} 
return G__48087__delegate.call(this,args);};
G__48087.cljs$lang$maxFixedArity = 0;
G__48087.cljs$lang$applyTo = (function (arglist__48091){
var args = cljs.core.seq(arglist__48091);
...
var G__48021 = o;
goog.object.set(G__48021,day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.cached_custom_prop_name(k),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__48103__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__48104__i < G__48104__a.length) {G__48104__a[G__48104__i] = arguments[G__48104__i + 0]; ++G__48104__i;}
  args = new cljs.core.IndexedSeq(G__48104__a,0,null);
} 
return G__48103__delegate.call(this,args);};
G__48103.cljs$lang$maxFixedArity = 0;
G__48103.cljs$lang$applyTo = (function (arglist__48105){
var args = cljs.core.seq(arglist__48105);
return G__48103__delegate(args);
});
...
var G__48029 = props;
var G__48029__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48029,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__48029);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48029__$1,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__48029__$1;
}
});
...
var props__$1 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.set_id_class((function (){var G__48030 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48030,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__48030;
}
})(),id_class);
...
day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.input_node_set_value = (function day8$re_frame_10x$inlined_deps$reagent$v0v10v0$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__48033){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48034__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__48047_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.input_handle_change(this$,on_change,p1__48047_SHARP_);
}));
} else {
return null;
}
...
var vec__48059 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48059,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48059,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48059,(2),null);
...
var temp__5739__auto___48129 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___48129 == null)){
} else {
var key_48130 = temp__5739__auto___48129;
(jsprops.key = key_48130);
}
...
var temp__5739__auto___48131 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___48131 == null)){
} else {
var key_48132 = temp__5739__auto___48131;
(jsprops.key = key_48132);
}
...
var G__48066 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__48066) : day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.call(null,G__48066));
} else {
var temp__5739__auto___48133 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___48133 == null)){
} else {
var key_48134 = temp__5739__auto___48133;
(jsprops.key = key_48134);
}
...
var G__48068 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__48068)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__48068)){
return x;
} else {
...
var G__48137 = (i__4737__auto___48136 + (1));
i__4737__auto___48136 = G__48137;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq48069){
var G__48070 = cljs.core.first(seq48069);
var seq48069__$1 = cljs.core.next(seq48069);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48070,seq48069__$1);
}));
...
break;
default:
var G__48139 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__48139;
continue;
...
var ctx = ({});
var vec__48081 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.ratom.check_derefs((function (){
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48081,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48081,(1),null);
...
var G__48084 = (cljs.core.count(argv) - first_child);
switch (G__48084) {
case (0):
