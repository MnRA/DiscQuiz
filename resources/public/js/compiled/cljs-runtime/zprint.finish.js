...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__49416_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__49416_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__49416_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__49420){
var vec__49421 = p__49420;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49421,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49421,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__49428,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49429__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49429__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49429__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__49433 = (function (){var or__4126__auto__ = color;
...
var fexpr__49432 = (function (){var G__49434 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__49434) : style_map.call(null,G__49434));
})();
return (fexpr__49432.cljs$core$IFn$_invoke$arity$1 ? fexpr__49432.cljs$core$IFn$_invoke$arity$1(G__49433) : fexpr__49432.call(null,G__49433));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__49435){
var vec__49436 = p__49435;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49436,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49436,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49436,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__49439){
var vec__49440 = p__49439;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49440,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49440,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49440,(2),null);
...
var G__49506 = cljs.core.next(ssv);
var G__49507 = (this_ssv == null);
var G__49508 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__49509 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__49506;
doing_nil_QMARK_ = G__49507;
last_elide = G__49508;
out = G__49509;
continue;
}
...
var vec__49446 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49446,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49446,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49446,(2),null);
...
var G__49510 = cljs.core.next(remaining_cvec);
var G__49511 = new_idx;
var G__49512 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__49510;
idx = G__49511;
out = G__49512;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__49453,cursor_vec){
var vec__49454 = p__49453;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49454,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49454,(1),null);
var focus_vec = vec__49454;
...
var vec__49457 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49457,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49457,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__49460){
var vec__49461 = p__49460;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49461,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49461,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__49468,existing_count){
var vec__49469 = p__49468;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49469,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49469,(1),null);
...
return cljs.core.filterv((function (p1__49465_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__49465_SHARP_))));
...
var vec__49482 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49482,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49482,(1),null);
var cvec_element = vec__49482;
if((cvec_element == null)){
var G__49524 = cljs.core.next(cvec_nl);
var G__49525 = (idx + (1));
var G__49526 = start;
var G__49527 = out;
cvec_nl = G__49524;
...
var G__49528 = cljs.core.next(cvec_nl);
var G__49529 = (idx + (1));
var G__49530 = idx;
var G__49531 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__49528;
idx = G__49529;
start = G__49530;
out = G__49531;
...
var G__49533 = cljs.core.next(cvec_nl);
var G__49534 = (idx + (1));
var G__49535 = (idx + (1));
var G__49536 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__49533;
idx = G__49534;
start = G__49535;
out = G__49536;
...
var G__49537 = cljs.core.next(cvec_nl);
var G__49538 = (idx + (1));
var G__49539 = idx;
var G__49540 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__49537;
idx = G__49538;
start = G__49539;
out = G__49540;
...
var G__49541 = cljs.core.next(cvec_nl);
var G__49542 = (idx + (1));
var G__49543 = start;
var G__49544 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__49541;
idx = G__49542;
start = G__49543;
out = G__49544;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__49486_SHARP_,p2__49485_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__49485_SHARP_)){
return cljs.core.reduced(p1__49486_SHARP_);
} else {
return (p1__49486_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__49487,p__49488){
var vec__49489 = p__49487;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49489,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49489,(1),null);
var vec__49492 = p__49488;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49492,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49492,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__49496,cvec,focus_vec){
...
var options = map__49497__$1;
var map__49498 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49497__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49498__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49498__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49498__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49495_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__49495_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
